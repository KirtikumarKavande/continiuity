class minHeap {
  ...
  deleteNode(element) {
    ...
    if (this.heap[leftChildIndex] < lastElement) {
      this.#heaifyDown(leftChildIndex)
    }
    let rightChildIndex = this.getRightChildIndex(index)

    if (this.heap[rightChildIndex] < lastElement) {
      this.#heaifyDown(rightChildIndex)
    }
...
console.log("Initial heap:", heap.getArray());
